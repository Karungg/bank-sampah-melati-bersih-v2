    ...
    <div class="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center justify-between">
        <div class="w-full mt-8 lg:mt-0 lg:w-2/3">
            ...
            <p class="text-sm indent-8 md:text-base text-justify mb-5">
                ...
                tanggal 31 Agustus 2013, dengan lokasi sekretariat di Perumahan Atsiri Permai, Jl. Kenanga IV No. 13,
                ...
                yang berlandaskan konsep 3R (Reduce, Reuse, Recycle) sebagai lembaga penggerak pemberdayaan masyarakat
                dalam pengelolaan sampah yang efektif. Salah satu upaya yang dilakukan adalah memilah sampah anorganik
                dan mengumpulkan minyak jelantah sebagai penerapan konsep green economy, yang memberikan manfaat besar
                ...
                aluminium, PE plastik, beling, kardus & kertas, kristal, botol, kabin, impact, lain-lain, dan jelantah.
            </p>
        </div>
