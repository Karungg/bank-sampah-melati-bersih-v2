        ...
        <div class="hero min-h-screen bg-cover bg-center"
            ...
            <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-white">
                ...
                <div class="w-full md:w-1/3 text-center justify-items-center">
                    ...
                    <button class="btn btn-warning text-white" @click="$refs.modal.showModal()">Lihat
                        pengumuman</button>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center justify-between">
            <div class="w-full mt-8 lg:mt-0 lg:w-2/3">
                ...
                <p class="text-sm md:text-base text-justify mb-5">
                    ...
                    Kenanga IV No.
                    13,
                    Desa Ragajaya, Kecamatan Bojonggede, Kabupaten Bogor. Kepengurusan Bank Sampah Melati
                    Bersih Atsiri
                    Permai RW 12 memiliki moto "Gerakan Bersih dan Senyum"
                    yang berlandaskan konsep 3R (Reduce, Reuse, Recycle) sebagai lembaga penggerak
                    pemberdayaan
                    masyarakat
                    dalam pengelolaan sampah yang efektif. Salah satu upaya yang dilakukan adalah memilah
                    sampah
                    anorganik
                    dan mengumpulkan minyak jelantah sebagai penerapan konsep green economy, yang memberikan
                    manfaat
                    besar
                    bagi perekonomian masyarakat serta kelestarian lingkungan. Jenis sampah anorganik dibagi
                    menjadi 15
                    kategori, yaitu: emberan, boncos, kaleng, seng, besi,
                    aluminium, PE plastik, beling, kardus & kertas, kristal, botol, kabin, impact,
                    lain-lain, dan
                    jelantah.
                </p>
            </div>
    ...
    <section class="pb-20">
        <div class="container mx-auto px-4 flex flex-col">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8 sm:gap-16">
                <div>
                    <div class="card h-36 sm:h-32 lg:h-36 xl:h-auto" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body">
                            <div class="flex justify-center">
                                <svg class="size-6 md:size-8 lg:size-10" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                </svg>
                            </div>
                            <p class="text-sm sm:text-center md:text-base lg:text-lg">1. Nasabah memilah
                                sampah di rumah
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card h-36 sm:h-32 lg:h-36 xl:h-auto" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body">
                            ...
                            <p class="text-sm sm:text-center md:text-base lg:text-lg">2. Datang ke
                                lokasi bank sampah
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card h-36 sm:h-32 lg:h-36 xl:h-auto" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body">
                            ...
                            <p class="text-sm sm:text-center md:text-base lg:text-lg">3. Mendaftar
                                nasabah baru
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card h-36 sm:h-32 lg:h-36 xl:h-auto" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body">
                            ...
                            <p class="text-sm sm:text-center md:text-base lg:text-lg">4. Menimbang
                                sampah
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card h-36 sm:h-32 lg:h-36 xl:h-auto" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body">
                            ...
                            <p class="text-sm sm:text-center md:text-base lg:text-lg">5. Menerima bukti
                                timbang
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card h-36 sm:h-32 lg:h-36 xl:h-auto" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body">
                            ...
                            <p class="text-sm sm:text-center md:text-base lg:text-lg">6. Login untuk
                                mengecek status
                            </p>
                        </div>
                    </div>
