    ...
    <section class="pb-20">
        <div class="container mx-auto px-4 flex flex-col">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8 sm:gap-16">
                <div>
                    <div class="card" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body p-2">
                            ...
                            <p class="text-xs sm:text-center md:text-base lg:text-lg">1. Nasabah memilah
                                sampah di rumah
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body p-2">
                            ...
                            <p class="text-xs sm:text-center md:text-base lg:text-lg">2. Datang ke
                                lokasi bank sampah
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body p-2">
                            ...
                            <p class="text-xs sm:text-center md:text-base lg:text-lg">3. Mendaftar
                                nasabah baru
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body p-2">
                            ...
                            <p class="text-xs sm:text-center md:text-base lg:text-lg">4. Menimbang sampah
                            </p>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="card" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body p-2">
                            ...
                            <p class="text-xs sm:text-center md:text-base lg:text-lg">5. Menerima bukti
                                timbang
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card" :class="darkMode ? 'steps-dark' : 'steps'">
                        <div class="card-body p-2">
                            ...
                            <p class="text-xs sm:text-center md:text-base lg:text-lg">6. Login untuk
                                mengecek status
                            </p>
                        </div>
                    </div>
