<nav x-data="{ open: false }"
    class="bg-gray-100 fixed top-0 right-0 left-0 z-10 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="shrink-0 flex gap-2 items-center">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('assets/images/logo.png') }}"
                            class="block size-10 w-auto fill-current text-gray-800 dark:text-gray-200" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                                <div>
                ...
                @guest
                    <a href="{{ route('login') }}" wire:navigate.hover
                        class="flex gap-1 items-center text-xs font-bold md:text-sm xl:text-base bg-gray-100 dark:bg-gray-800 dark:text-gray-400 shadow-none text-gray-500 hover:text-black dark:hover:text-gray-100 {{ request()->routeIs('login') ? 'text-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" class="size-4 md:size-5 xl:size-6">
                ...
                <div class="ms-5">
                    <label class="swap swap-rotate">
                        ...
                        <input type="checkbox" class="theme-controller" @click="toggleTheme" x-model="darkMode" />

                        <!-- sun icon -->
                        <svg class="swap-off size-4 md:size-5 xl:size-6 fill-current" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
                        ...
                        <!-- moon icon -->
                        <svg class="swap-on size-4 md:size-5 xl:size-6 fill-current" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <div class="mr-3">
                    <label class="swap swap-rotate">
                        ...
                        <!-- sun icon -->
                        <svg class="swap-off size-6 fill-current" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
                                d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" />
                        </svg>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="@auth pt-4 @endauth pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                @guest
                    <a href="{{ route('login') }}" wire:navigate.hover
                        class="flex m-4 gap-1 items-center font-bold text-sm xl:text-base bg-gray-100 dark:bg-gray-800 dark:text-gray-400 shadow-none text-gray-500 hover:text-black dark:hover:text-gray-100 {{ request()->routeIs('login') ? 'text-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
